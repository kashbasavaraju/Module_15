    ...
    source = intent_request["invocationSource"]
      ...
      if source == "DialogCodeHook":
        ...
        if age is not None:
            ...
            if age <0:
                return build_validation_result(False, "Enter an age between 0 and 65")
            elseif age >=65:
                return build_validation_result(False, "Enter an age between 0 and 65")
        ...
        if investment_amount is not None:
            ...
            if investment_amount< 5000:
                return build_validation_result(False,"Please enter an investment amount is $5000")
            else:
        ...
        "Fulfilled",
        {
            ...
            "content": """{} Thanks!
            based on the risk level input, the optimal investment portfolio would be {}
            """.format(
